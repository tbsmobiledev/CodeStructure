...
import com.codestructure.adapter.ListAdapter;
...
public class ListFragment extends Fragment {
    ...
    private void init(View view) {
        ...
        rv_home_list.setLayoutManager(new GridLayoutManager(getActivity(), 2));
    ...
    private void bindHome() {
        ...
        if (homeBeanArrayList != null && homeBeanArrayList.size() > 0) {
            ListAdapter listAdapter = new ListAdapter(getActivity(), homeBeanArrayList);
            rv_home_list.setAdapter(listAdapter);
        }
    }
